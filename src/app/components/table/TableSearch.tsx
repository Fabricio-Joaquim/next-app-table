...
export const TableSearch = ({ resetSearch, search, handlerChangeSearch }: TableSearchProps) =>
    ...
    <div className='flex gap-0 md:gap-2 justify-center w-full md:w-1/3 bg-gray-200 rounded h-11 md:h-auto'>
        <input onChange={handlerChangeSearch} name="search" value={search} className="border-none rounded py-0 md:py-3 pl-2 bg-gray-200 focus:border-none w-full
